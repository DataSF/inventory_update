...
def main():
  ...
  for item in email_list[0:2]:
    ...
    attachment_dictList = [{'fake_attachment.xlxs': wkbks_dir+'fake_attachment.xlxs'},{ 'InventoryUpdateGuidance.pdf': wkbks_dir+'InventoryUpdateGuidance.pdf'}]
    recipientsActual = {'To':item['primary_data_coordinator']}
